        ...
        <div class="row">
            <form v-on:submit="updateContact" class="col-sm-9" method="post" id="updateContact">
                ...
                <div class="form-group">
                    ...
                    <VueImgInputer v-model="file" :imgSrc="contact.avatar" accept="image/*" theme="material"
                                   bottomText="click to change profile image" placeholder="please select profile image"
